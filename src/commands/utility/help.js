...
async function getHelpMenu({ client, guild }) {
  ...
  const supportButton = new ButtonBuilder()
    ...
    .setURL("https://discord.com/invite/VJxGnpKra7");
...
> <:circle:1362988697338773765> Modified by \`iCognitoo\`
> <:circle:1362988697338773765> Created by \`Cognixion Studio\``);
