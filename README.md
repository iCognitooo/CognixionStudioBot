...
```
git clone https://github.com/iCognitooo/CognixionStudioBot.git
cd "FolderName"
npm install
```
...
- Special thanks to [@iCognitooo](https://github.com/iCognitooo/) the owner of this code.
- Feel free to [Fork](https://github.com/iCognitooo/CognixionStudioBot/fork) this repository, create a feature branch and submit a pull request
